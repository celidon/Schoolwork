...
#declare variables
my ($game, $commercial, @records, @errors, $size);
my @game_count = (0, 0, 0);
...
if ($commercial ne "Budweiser" and $commercial ne "FedEx"
	and $commercial ne "MasterCard" and $commercial ne "Pepsi") {
...
if ($size == 0) {
	...
	print "<HTML><HEAD><TITLE>WKRK-tV</TITLE></HEAD>\n";
	print "<BODY>\n";
	print "<H2>Please press your browser's Back buttonto return to the survey, then:</H2><BR>\n";
