/*
 ...
 Description: This class contains the information for each address listed.
 			  In order to complete the assignment, a new method 'deliminated()'
			  was added in order to put the address info into a deliminated list
 Author: Anthony Hansen
 Email Address: hansen.tony92@gmail.com
 Date Created: * Wed May 28 14:49:20 PDT 2014
 * */
...
public class Address
{
	...
	public String deliminated()
	{
		return getFirstname()+", "+getLastname()+", "+getStreet()+", "+getCity()+", "+getState()+", "+getZip();
	}
}
