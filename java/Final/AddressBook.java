/*
 ...
 Description: The assignment was to implement the add address method in order to
 			  allow the program to store the addresses in a list and output them
			  to a file. The file 'Address.java' was also modified in order to
			  make creating a deliminated list easier.
 Author: Anthony Hansen
 Email Address: hansen.tony92@gmail.com
 Date Created: * Wed May 28 14:51:18 PDT 2014
 * */
import java.util.*;
import java.awt.*;
...
public class AddressBook extends JPanel
    ...
    {
		// make sure that you type cast the state to a String
		// eg. (String)stateSpinner.getValue()
		...
		try{
			out=new PrintWriter("address.txt");
			for(Address a:addresslist)
			{
				out.write(a.deliminated()+"\n");
			}
			out.close();
